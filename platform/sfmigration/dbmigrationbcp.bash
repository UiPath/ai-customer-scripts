...
sqlcmd -S $DESTINATION_SERVER -U $DESTINATION_DB_USERNAME -P $DESTINATION_DB_PASSWORD -d $DESTINATION_DB_NAME -Q "update "$DESTINATION_DB_SCHEMA"."$TableName" set tenant_id = '"$DESTINATION_TENANT_ID"' where tenant_id = '"$SRC_TENANT_ID"';"
...
do
update_database_table  $TableName $SRC_SERVER $SRC_PKGMANAGER_DB_NAME $SRC_PKGMANAGER_DB_SCHEMA $SRC_PKGMANAGER_DB_USERNAME $SRC_PKGMANAGER_DB_PASSWORD $DESTINATION_SERVER $DESTINATION_DB_NAME $DESTINATION_PKGMANAGER_DB_SCHEMA $DESTINATION_DB_USERNAME $DESTINATION_DB_PASSWORD $SRC_TENANT_ID $DESTINATION_TENANT_ID
done

# Updating all the table for ai_trainer db
for TableName in ${TrainerDBTableNames[*]} 
do
update_database_table  $TableName $SRC_SERVER $SRC_TRAINER_DB_NAME $SRC_TRAINER_DB_SCHEMA $SRC_TRAINER_DB_USERNAME $SRC_TRAINER_DB_PASSWORD $DESTINATION_SERVER $DESTINATION_DB_NAME $DESTINATION_TRAINER_DB_SCHEMA $DESTINATION_DB_USERNAME $DESTINATION_DB_PASSWORD $SRC_TENANT_ID $DESTINATION_TENANT_ID
done
